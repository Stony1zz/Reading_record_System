...
public class UserLoginIFrame extends JFrame {
	...
	public UserLoginIFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserLoginIFrame.class.getResource("/icon/book_200px.png")));
		
		JLabel Label_toppicture = new JLabel("");
		Label_toppicture.setIcon(new ImageIcon(UserLoginIFrame.class.getResource("/icon/login.png")));
		...
		loginButton.setIcon(new ImageIcon(UserLoginIFrame.class.getResource("/icon/login_button_16px.png")));
		...
		resetButton.setIcon(new ImageIcon(UserLoginIFrame.class.getResource("/icon/reset_button_16px.png")));
		...
		UserLabel.setIcon(new ImageIcon(UserLoginIFrame.class.getResource("/icon/user_16px.png")));
		
		JLabel passwordLabel = new JLabel("密    码：");
		passwordLabel.setIcon(new ImageIcon(UserLoginIFrame.class.getResource("/icon/Password_16px.png")));
	...
	public static void setUser(Admin currentAdmin) {
		UserLoginIFrame.currentAdmin = currentAdmin;
	}
